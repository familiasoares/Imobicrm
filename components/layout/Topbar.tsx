...
// 🚀 O IMPORT ABAIXO É O QUE RESOLVE O ERRO:
...
const PAGE_TITLES: Record<NavItemId, string> = {
    ...
    // 🚀 ADICIONADO PARA O DEPLOY PASSAR:
...
export function Topbar({ onNewLead }: TopbarProps) {
    ...
    // Fallback caso a página ativa não esteja no mapa (evita erro de undefined)
    const pageTitle = PAGE_TITLES[activePage] || "Wave CRM";
